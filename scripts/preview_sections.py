...
def _article(s, ctx):
    ...
    bc = f'<nav class="pv-bc" aria-label="Breadcrumb"><a href="{E(ctx["L"]("index.html"))}">Home</a><span>/</span><a href="{E(ctx["L"](s.get("crumb_href", "blog.html")))}">{E(s.get("crumb_label", "Blog"))}</a><span>/</span>{E(s["category"])}</nav>'
