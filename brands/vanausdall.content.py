...
SERVICES = [
    ["managed-it", "Managed IT services", "Managed IT services", "Information", "assets/datacenter-1200.jpg", "Managed IT",
    ...
    ["cybersecurity", "Managed security services", "Cybersecurity", "Information", "assets/security-1200.jpg", "Vsecure managed security",
    ...
    ["business-phone-systems", "Business phone systems", "Business phone systems", "Communication", "assets/phones-1200.jpg", "Unified communications",
    ...
    ["copiers", "Copiers and printers", "Copiers and printers", "Print", "assets/copier-1200.jpg", "Copier sales, lease and rental",
    ...
    ["copier-service", "Copier service and repair", "Copier service and repair", "Print", "assets/support-1200.jpg", "Service and repair",
    ...
    ["document-conversion", "Document conversion", "Document conversion", "Process", "assets/support-1200.jpg", "Document Conversion Center",
...
post("what-is-a-vcio", "Managed IT", "What a vCIO does, and when a 50-person company needs one",
     ...
     "assets/datacenter-1200.jpg", "A technician with a tablet in front of server racks",
...
post("business-phone-systems-buyers-guide", "Communication", "Business phone systems in 2026: cloud, premise or hybrid, and how to choose",
     ...
     "assets/phones-1200.jpg", "A desk phone and headset in a modern office",
...
post("document-conversion-services-what-to-expect", "Process", "Document conversion services: what actually happens to your boxes",
     ...
     "assets/support-1200.jpg", "Boxes of records staged for scanning",
    ...
    return {"crumbs": [["Home", "index.html"], ["Locations", "locations.html"], [city, f"locations/{slug}.html"]], "file": f"locations/{slug}.html", "title": f"Office Technology, Copiers and Managed IT in {city}, IN | Van Ausdall & Farrar",
            ...
            "sections": [
                {"type": "hero", "layout": "split", "eyebrow": eyebrow, "heading": f"<em>{city}</em> copiers, managed IT and phone systems, serviced locally.",
                 ...
                 "image": "assets/hq-1200.jpg" if hq else "assets/team-1200.jpg", "image_alt": "The Van Ausdall & Farrar headquarters in Indianapolis" if hq else "Office technology professionals at work", "image_w": 1200, "image_h": 800,
...
def build():
    ...
    pages.append({"file": "index.html", "title": "Van Ausdall & Farrar | Managed IT, copiers, phone systems and office technology in Indianapolis",
        ...
        {"type": "hero", "id": "hero-light", "layout": "split", "eyebrow": "Business technology simplified, since 1914",
         ...
         "subhead": "IT support, copiers and print, phone systems, document workflow and AI guidance for Indiana businesses. One local partner, one assessment to start, one number to call.",
         "primary": {"label": "Take the Technology Strength Assessment", "href": "technology-strength-assessment.html"}, "secondary": {"label": "Schedule a consultation", "href": "contact.html"},
         "note": "Canon, Ricoh, Kyocera, HP, Mitel, Fortinet, Sophos and Microsoft partner", "image": "assets/datacenter-1200.jpg", "image_alt": "A technician with a tablet checking a row of servers", "image_w": 1200, "image_h": 800,
    ...
    pitch = {
        ...
        "prepared_for": "Patrick Dodge and the Van Ausdall & Farrar team",
        "heard_intro": "We have not interviewed you about the website yet. Everything here comes from vanausdall.com, the CEO Juice report it links to, and Semrush. Tell us if any of it is wrong; it outranks our house defaults.",
        "heard": [
        ...
        "found": [
            ...
            "The pages earning strangers today are the Fort Wayne and Evansville managed IT pages and a blog post on physical intrusion detection. Indianapolis, the headquarters market, does not appear in the top fifty keywords for managed IT.",
            ...
            "The contact form on the home, contact, support and print assessment pages renders a placeholder string (as5d4f65s4f564we654fw) instead of a form. Visitors who want to talk cannot.",
            "Blog posts live on query-string URLs (blog?p=...), which cannot carry their own titles, images or schema cleanly. Every post gets a real URL now, and every earning URL gets a redirect.",
        ...
        "search": {
            ...
            "today_stats": [["1,081", "Organic visits a month"], ["80%", "Of them from people searching your name"], ["365", "Keywords ranking, most on page two or beyond"], ["85%", "Of all traffic lands on the home page"]],
            "today": [
                ...
                "The best non-brand page is the Fort Wayne managed IT page: 49 keywords, position 6 for managed it services fort wayne. Evansville managed IT ranks 2 for managed it evansville. Indianapolis does not appear in the top fifty for managed IT.",
                ...
                "Blog posts live at blog?p=..., query-string URLs that share one page's title and image.",
                ...
                "The contact form renders a placeholder string on the home, contact, support and print assessment pages.",
            ...
            "after": [
                ...
                "A business phone systems page and a buyer's guide aimed at the 9,900-a-month term you already sit at 25 for, and a managed IT page with Indianapolis in the title.",
        ...
        "confirm": [
            ...
            "Who approves: one name for the direction, one for copy, one for go-live."],
        "footer": "Prepared for Patrick Dodge and the Van Ausdall & Farrar team. Nothing here is live or indexed. Every number we could source comes from vanausdall.com, the CEO Juice report it links to, or Semrush on 8 September 2026. Where we drafted a process or a commitment we think you make, it is listed under To confirm. Photographs are the ones on your site today; partner logos are the ones on your partners page.",
    }
