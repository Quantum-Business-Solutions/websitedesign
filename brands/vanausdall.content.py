    ...
    pitch = {
        ...
        "search": {
            ...
            "today": [
                ...
                "\"Managed it services indianapolis\" is 1,000 searches a month at difficulty 29. Asked from Indianapolis the top ten are Leap, Cloudtango, GadellNet, mis.tech, Meriplex, Exact IT, ESI, Visual Edge, Corsica and Resultant. VAF is in none of them, while the identical page template in Fort Wayne ranks 4 and 6 for its own city terms.",
