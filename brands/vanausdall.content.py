...
def build():
    ...
    pitch = {
        ...
        "found": [
            ...
            "The market leaders are gflesch.com at Authority Score 42 with 66,688 visits a month, visualedgeit.com at 33 with 6,571, and appliedinnovation.com at 32 with 5,986. Van Ausdall & Farrar has 1,081 visits from 380 keywords at Authority Score 21.",
            "Authority is the gap as well as pages: 510 referring domains against a competitor median of 1,211, and one domain, indianaruralhealth.org, is the source of 45.6 percent of every link to the site.",
            "Nobody in this market carries FAQ, Service or Review markup on their Indianapolis page, so the answer-shaped signals are open ground rather than catch-up.",
        ...
        "search": {
            ...
            "intro": "Measured before we touched anything, so the work can be judged against it. Numbers from Semrush, a crawl of all 171 pages and eleven live buyer searches run from Indianapolis, Columbus and South Bend on 15 September 2026.",
            "as_of": "Semrush, a crawl of all 171 pages and eleven live buyer searches, 15 September 2026",
            "report_href": "https://clientcommand.thequantumleap.business/pages/0d27b48f-aec7-436e-87d5-0aa1cc08caf7", "report_label": "Read the full SEO and AI search analysis",
            "findings": SEO_FINDINGS[:5],
            "site_audit": SITE_AUDIT,
            "compare_rows": [
                ["Pages with FAQPage schema", "4 of 171", "168 of 168"],
                ["Pages with Service or Article schema", "3 of 171", "143 of 168"],
                ["Pages with a question-form heading", "22 of 171", "168 of 168"],
                ["Pages under 300 words", "65 of 171", "0 of 168"],
                ["Average words per page", "463", "827"],
                ["Pages with BreadcrumbList schema", "0 of 171", "167 of 168"],
                ["Pages with Review or rating schema", "0 of 171", "0 of 168, until the review programme runs"],
                ["llms.txt published for AI assistants", "no", "yes"],
                ["Titles naming Indianapolis or an Indiana city", "58 of 171", "168 of 168"],
            ],
            "compare_lede": "The left column is the 15 September analysis of vanausdall.com. The right column is the same counts run on the build. Every recommendation on the cards below is already in place on all three options.",
            "compare_note": "Review markup is deliberately left out until real Google reviews exist; no competitor in this market has it either.",

            "today_stats": [["373", "Organic keywords; 80% of the traffic is people searching your name"], ["1,081", "Organic visits a month, worth about $960 in equivalent paid traffic"], ["0 of 10", "Top-ten results for managed it services indianapolis, 1,000 a month"], ["21", "Authority Score, against gflesch.com 42, visualedgeit.com 33, appliedinnovation.com 32"]],
            "today": [
                "Four visits in five come from people searching your name. Semrush records 373 organic keywords and 1,081 visits a month, worth about $960 in equivalent paid traffic, and five brand phrases take 79.9 percent of it. The home page alone carries 85.56 percent of site traffic.",
                "\"Managed it services indianapolis\" is 1,000 searches a month at difficulty 29. Asked from Indianapolis the top ten are Leap, Cloudtango, GadellNet, mis.tech, Meriplex, Exact IT, ESI, Visual Edge, revenuebase.ai and Corsica. VAF is in none of them, while the identical page template in Fort Wayne ranks 4 and 6 for its own city terms.",
                "Answer-shaped content scores 21 of 100, the lowest component on the scorecard. FAQPage markup appears on 4 of 110 service, industry and location pages, question headings on 23, and Service or Article schema on 3 of 113 buyer and blog pages.",
                "Authority Score is 21 from 510 referring domains, against gflesch.com at 42 with 1,656 domains and 66,688 visits a month, visualedgeit.com at 33 with 2,353 domains, and appliedinnovation.com at 32. One domain, indianaruralhealth.org, is the source of 45.6 percent of every link to the site.",
                "Review markup is absent from all 171 pages, and \"van ausdall & farrar reviews\" returns Indeed four times, Glassdoor three times, Facebook and Yelp, with vanausdall.com nowhere. Buyers read what former staff said about working there.",
                "The three best pages on the site, /copiers/ at 96, /copier-service-repair at 91 and /copy-print-solutions/ at 86, are the only ones carrying question headings, FAQPage and Service schema together. That is the template, and it has been applied three times out of 171.",
            ],
            "after": [
                "Every page carries a five-question FAQ marked up as FAQPage, question-form headings an assistant can quote, and Service schema naming the service and the area served.",
                "Indianapolis becomes a hub page linking to all nine money pages, paired with the managed IT page that already scores 81, which is the single change with the most measured demand behind it.",
                "The ten thin location pages are rebuilt, Columbus and South Bend first, because those are the two with measured demand.",
                "llms.txt and BreadcrumbList are published, closing the two free access signals the analysis flags, and every title names its city.",
                "No page drops below 300 words; the build averages 827 against 463 today.",
                "Review markup waits for real Google reviews. No competitor in this market has it either, so it stays the differentiating signal rather than a shortcut.",
            ],
            "keep": [
        ...
        "footer": "Prepared for Brian Courtney and the Van Ausdall & Farrar team, following the 1 September call with Patrick Dodge. Nothing here is live or indexed. Every number we could source comes from vanausdall.com, the CEO Juice report it links to, or Semrush on 15 September 2026. Where we drafted a process or a commitment we think you make, it is listed under To confirm. Hero and service photographs are generated stand-ins for the preview, marked as such, until a half-day shoot at the headquarters and in the field; secondary imagery is from your site today; partner logos are the ones on your partners page.",
    }
