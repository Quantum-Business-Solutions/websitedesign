...
LOCATIONS = [
    ...
    ["winston-salem", "Winston-Salem", "163 South Stratford Road", "Winston-Salem, NC 27103", "(336) 725-2566", "tel:3367252566", "Headquarters, the Triad"],
    ["greensboro", "Greensboro", "1040 E. Wendover Ave.", "Greensboro, NC 27405", "(336) 232-0399", "tel:3362320399", "The Triad"],
    ["charlotte", "Charlotte", "4205-B Stuart Andrew Blvd.", "Charlotte, NC 28217", "(704) 588-6891", "tel:7045886891", "Charlotte metro"],
    ["raleigh", "Raleigh", "6001 Chapel Hill Rd, Suite 103", "Raleigh, NC 27607", "(919) 378-0172", "tel:9193780172", "The Triangle"],
]
PARTNERS = ["Ricoh", "Savin", "Konica Minolta", "Sharp", "Brother", "Epson", "Dell", "DocuWare", "Datto", "WatchGuard", "Microsoft 365", "Zultys", "Wellsys", "FloWater", "Manitowoc", "Follett", "NEWCO"]
INDUSTRIES = [  # slug, name, image, one-line, body, bullets, faq
    ["legal", "Legal", "assets/doc-mgmt-1200.jpg",
     ...
     [["Can you integrate with our practice management system?", "Usually. Tell us which one and we will say plainly what the integration covers before you sign anything."], ["Do you handle secure disposal of old devices?", "Yes. Hard drives are wiped or destroyed when a device leaves, and you receive the record."]]],
    ["healthcare", "Healthcare", "assets/mps-2-1200.jpg",
     ...
     ["Secure print release and secure fax on every device", "DocuWare patient and HR records with role-based access", "Fleet monitoring so toner and service happen before the front desk notices", "Multi-site practices served from four North Carolina branches"],
     [["Are your devices and workflows HIPAA-aware?", "The devices and DocuWare are configured with the controls a HIPAA review looks for: access, audit trail, encryption at rest and in transit. Your compliance officer confirms the policy; we build to it."], ["What happens when a device fails during clinic hours?", "Call the branch. For devices under a Kelly agreement the response is same day, and technicians carry parts for the models we sell."]]],
    ["faith-based", "Faith-based", "assets/production-print-1200.jpg",
     ...
     "Churches and ministries produce a remarkable amount of print: weekly bulletins, event programs, mailings, curriculum. Kelly right-sizes production print for the volume you actually run, adds folding and stapling inline, and keeps the cost per piece visible so the finance committee can see it too.",
     ...
     [["We are a small church. Is this for us?", "Yes. Right-sizing is the point. Many congregations spend more at the copy shop than a small production device would cost them."], ["Do you offer nonprofit pricing?", "Ask your branch. We will price lease, rental and purchase side by side for your real volume."]]],
    ...
    ["manufacturing", "Manufacturing", "assets/it-1-1200.jpg",
     "Devices on the floor, forms and labels that keep the line moving, and IT that keeps the systems up.",
     "Plants print travelers, labels and forms in places offices never see. Kelly places rugged devices where they are used, handles label and forms printing, and adds managed IT, backup and security so the systems the line depends on stay up.",
     ["Devices placed and serviced on the plant floor", "Label, forms and traveler printing", "Managed IT, backup and firewall for plant systems", "Supplies delivered before the line runs out"],
     [["Can you service devices in a dusty or hot environment?", "We place devices rated for it and service them on a schedule that matches the environment. Ask your branch to walk the floor with you."], ["Do you support multiple shifts?", "Service is scheduled around your production hours. Tell dispatch when the line can spare the device."]]],
]
SERVICES = [  # slug, title, nav label, image, eyebrow, hero heading (with <em>), subhead, benefits (title, body), bullets, extra sections, faq
    ["copiers", "Office products and copiers", "Copiers and printers", "assets/mps-1-1200.jpg", "Office products",
     ...
     ["Lease, rent or buy, priced side by side for your real volume", "Secure print release and scan-to-cloud on every device", "Trade-in and takeover of devices you already own, where we support the model", "Driver downloads and online training for your team"],
    ...
    ["managed-print", "Managed print services", "Managed print", "assets/dispatch-1200.jpg", "Managed print",
     ...
     [["Reduced costs", "One agreement replaces per-device contracts, retail toner and surprise repairs."], ["Automated toner replenishment", "Devices report their own levels; supplies ship before you run out."], ["Enhanced security", "Secure print release, user authentication and device hardening as standard."], ["Predictable billing", "One monthly invoice that matches your meters."], ["Maximized uptime", "Monitoring flags a failing device before your people do."]],
     ["Assessment of every device, wherever it came from", "Monitoring and a monthly usage report", "Leasing and rental options for the fleet the plan recommends", "Quarterly review of cost per page and uptime"],
     [["What does the assessment cost?", "Ask your branch. Our recommendation is that you keep the report whether or not you buy."], ["Can you manage devices we did not buy from you?", "Often, yes. The assessment tells you which are worth keeping under agreement and which are costing more than they are worth."]]],
    ["document-management", "Document management", "Document management", "assets/doc-mgmt-1200.jpg", "Document management",
    ...
    ["production-print", "Production print", "Production print", "assets/production-print-1200.jpg", "Production print",
     ...
     ["High-volume color and mono production systems", "Wide-format for plans, posters and signage", "Operator training and same-day service under agreement", "A cost comparison against your current outsourced spend"],
     [["What volume justifies production print?", "Bring your outsourced invoices to the assessment. The comparison is usually clear within a year."], ["Can you train our operator?", "Yes, on the day of install, and again whenever staff changes."]]],
    ["it-services", "IT services", "IT services", "assets/it-1200.jpg", "IT services",
     ...
     [["Reduced costs", "One monthly number instead of emergency invoices."], ["Proactive monitoring", "Problems found and fixed before they become tickets."], ["Optimized security", "Firewall, endpoint and email protection kept current."], ["Fixed monthly invoices", "Budgetable IT."], ["Maximized uptime", "Backup and disaster recovery you have actually tested."]],
    ...
    ["mailing", "Mailing solutions", "Mailing", "assets/postage-1200.jpg", "Mailing solutions",
     ...
     ["Postage meters with automatic rate updates", "Folder-inserters for statements and invoices", "Parcel lockers for offices and multifamily buildings", "Parcel shipping and RemoteOne / MailOne software"],
    ...
    ["pure-technology", "Pure Technology: water, ice and coffee", "Water, ice and coffee", "assets/breakroom-1200.jpg", "Pure Technology",
     ...
     "Bottleless filtered water coolers from Wellsys and FloWater, commercial ice machines from Manitowoc and Follett, and bean-to-cup coffee. One invoice, one technician, one less vendor.",
     ...
     [["Why bottleless?", "No jugs to lift, store or run out of, and filtered water that costs less per gallon than delivery."], ["How often are coolers sanitized?", "On the schedule the manufacturer recommends, and we log it. Ask your branch for the interval on your model."]]],
]
...
post("what-managed-print-costs", "Managed print", "What managed print services cost in North Carolina, and what they replace",
     ...
     [{"id": "the-four-numbers", "title": "The four numbers that set the price", "paras": [
      ...
      {"id": "cost-per-page", "title": "Cost per page, and why blended is the number to watch", "paras": [
         "Vendors quote a mono rate and a color rate. The number that matters is the blended cost per page across your real mix, because a fleet that prints 20% color can cost more than one that prints 60% mono at a higher mono rate. Ask any vendor for the blended figure on your volumes, and ask how it changes if color grows.",
...
post("copier-lease-vs-buy", "Copiers", "Copier lease vs. buy vs. rent: the decision in one page",
...
post("document-management-how-it-works", "Document management", "Document management: how it works and why it matters",
     ...
     [{"id": "what-it-is", "title": "What a document management system does", "paras": [
         ...
         "ul:Capture from scanners, email and existing systems;;Indexing by the fields your business uses;;Workflow: approvals that route themselves;;Retention and audit trail;;Search your people will actually use"]},
      {"id": "accounts-payable", "title": "Why accounts payable usually goes first", "paras": [
         ...
         "pq:Accounts payable goes first because the payback is measured in weeks, not years."]},
     ...
     [["Cloud or on premise?", "Either. Most customers choose cloud."], ["Does it work with our accounting system?", "Usually. Tell us which one and we will say what the integration covers."], ["How long does a first workflow take?", "Ask for a plan. Accounts payable is often live within weeks."]],
     "document management compliance", "what-we-do.html#document-management", "Talk to us about document management")

post("how-managed-print-transforms-a-business", "Managed print", "The first ninety days of managed print: what actually changes",
     ...
     [{"id": "the-three-costs", "title": "The three costs nobody counts", "paras": [
      ...
      {"id": "days-61-90", "title": "Days 61 to 90: the first report", "paras": [
         "The first monthly report shows pages, color share, uptime and cost per page by device. This is usually the first time anyone in the business has seen the number. It is also where the conversation about color policy starts.",
     ...
     [["Will we lose devices we like?", "Only if the data says they cost more than they are worth, and only if you agree."], ["Who reads the meters?", "The devices do, automatically, under monitoring."], ["What if a device fails in week two?", "Under agreement the response is same day, and the technician carries parts for the models we sell."]],
     "benefits of a managed print service")

post("workstation-management-overview", "Office IT", "Workstation management: why the desk PC is where most support tickets start",
     ...
     [{"id": "where-tickets-start", "title": "Where the tickets actually start", "paras": [
         ...
         "ul:Patching and updates that run on a schedule, not when someone remembers;;Endpoint security that is actually current;;Backup of the files that live on the machine;;Asset records: who has what, and when it is due for replacement"]},
      ...
      {"id": "security", "title": "Security starts at the endpoint", "paras": [
         "Most breaches begin with an email opened at a desk. WatchGuard firewalls, endpoint protection and email security, kept current across every machine, close the door that is most often left open.",
         "pq:Most breaches begin with an email opened at a desk."]},
     ...
     [["Do you support Mac and Windows?", "Yes."], ["Can you work alongside our internal IT person?", "Yes. Many customers keep one person in house and use Kelly for monitoring, patching and after-hours."], ["What does onboarding look like?", "An inventory, enrollment of every machine, then monitoring. Ask your branch for the plan."]],
     "workstation support", "what-we-do.html#it", "Talk to us about IT services")

post("how-to-clean-a-water-cooler", "Pure Technology", "How to sanitize an office water cooler, step by step",
     "The routine our technicians follow on bottleless coolers, how often an office should do it, and the signs a cooler is overdue.",
     ...
     [{"id": "how-often", "title": "How often a cooler needs sanitizing", "paras": [
         "Manufacturers recommend sanitizing bottleless coolers on a regular schedule, and replacing filters on their rated interval. In a busy office, the schedule matters more than the method: a cooler that is cleaned well twice a year is worse than one cleaned adequately every quarter.",
      ...
      {"id": "what-you-need", "title": "What you need", "paras": [
         "ul:The manufacturer's sanitizing solution, or the approved alternative for your model;;Clean cloths and a soft brush;;A bucket for draining;;Replacement filters if due;;The manual, for the drain and reservoir access on your model"]},
      {"id": "the-steps", "title": "The steps", "paras": [
         "ul:Unplug the cooler and shut the water supply;;Drain the hot and cold reservoirs completely;;Mix the sanitizing solution as the manufacturer directs;;Fill the reservoirs, let it sit for the specified time, then drain;;Flush with clean water at least twice, until no taste or odor remains;;Wipe the taps, drip tray and exterior;;Replace filters if due, reconnect, plug in, and let it reach temperature before use",
         "pq:Flush until there is no taste. Then flush once more."]},
      {"id": "signs-overdue", "title": "Signs a cooler is overdue", "paras": [
         "Off taste or odor, slow flow, visible film in the drip tray, or water that is not cold. Any one means sanitize now and check the filter."]},
      {"id": "why-bottleless", "title": "Why offices are moving to bottleless", "paras": [
         "No jugs to lift, store or run out of, and filtered water that costs less per gallon than delivery. Kelly installs and services Wellsys and FloWater coolers across North Carolina, on the same visit as your copier."]}],
     [["Can Kelly sanitize our cooler for us?", "Yes, on schedule, under a Pure Technology agreement."], ["How do I know when the filter is due?", "The service log and the interval for your model. Ask your branch."], ["Do you service coolers you did not install?", "Often. Ask."]],
     "how to sanitize a water cooler", "what-we-do.html#pure", "Talk to us about water, ice and coffee")

post("all-in-one-office-printer", "Copiers", "All-in-one office printers: when one device is enough, and when it is not",
     ...
     [{"id": "one-device", "title": "When one device is enough", "paras": [
         "A team of up to about fifteen people with moderate volume, mostly mono, in one location, is usually well served by one multifunction device that prints, copies, scans and faxes. The savings are real: one contract, one toner type, one thing to service."]},
     ...
     [["Which all-in-one brands does Kelly carry?", "Ricoh, Savin, Konica Minolta, Sharp and Brother, matched to the job."], ["Can we add managed print to a single device?", "Yes."], ["Can you network it for us?", "Yes, on the day of install, with every user trained."]],
     "best all in one printer small business", "what-we-do.html#copiers", "Talk to us about copiers")

post("wide-format-printers-for-business", "Wide format", "Wide-format printing in house: the volume at which it pays for itself",
     ...
     [{"id": "who-uses-it", "title": "Who prints wide format", "paras": [
      ...
      {"id": "the-math", "title": "The math", "paras": [
         "Add up a year of print-shop invoices and delivery fees, then add the hours lost waiting for revisions. Compare it to the monthly cost of a device under agreement, including ink and media. For firms that print weekly, the device usually wins within the first year.",
      ...
      {"id": "with-kelly", "title": "How Kelly sets it up", "paras": [
         "Installation includes network setup and operator training on the day. Ink and media can be on automatic replenishment. Service is same day under agreement, from the nearest of four branches."]}],
...
post("same-day-service-what-it-means", "Service", "What same-day service actually means, and the questions to ask any dealer",
     ...
     [{"id": "response-vs-resolution", "title": "Response time is not resolution time", "paras": [
         ...
         "callout:Parts on the truck|Kelly technicians carry parts for the models we sell. It is the single biggest factor in first-visit resolution."]},
      {"id": "in-writing", "title": "Get it in writing, with conditions", "paras": [
         "A real commitment names the devices it covers, the hours it applies to, and what happens when it is missed. Kelly's commitment for devices under agreement is same-day response in all four territories; ask your branch for the exact terms for your agreement.",
      ...
      {"id": "local", "title": "Why local still matters", "paras": [
         "A technician who is forty minutes away arrives in forty minutes. Kelly serves the Triad, Charlotte and the Triangle from four branches, and customers with field offices across North Carolina from the nearest one."]},
     ...
     [["Does same-day apply to every device?", "It applies to devices under a Kelly agreement. Ask your branch for the terms."], ["What about weekends?", "Ask your branch for the coverage on your agreement."], ["How do I request service?", "The customer portal, the branch number, or 1-800-34-KELLY."]],
...
def industry_page(slug, name, image, one, body, bullets, faq):
    return {"file": f"industries/{slug}.html", "title": f"Office technology for {name.lower()} | Kelly Office Solutions",
            "description": f"{one} Copiers, managed print, document management and IT for {name.lower()} across North Carolina, from four local offices.",
            "sections": [
                {"type": "hero", "layout": "centered", "eyebrow": f"Key markets: {name}", "heading": f"{one.split(',')[0]}<em>{one[len(one.split(',')[0]):]}</em>" if "," in one else one, "subhead": body,
                ...
                {"type": "testimonials", "alt": True, "heading": "What customers in North Carolina say", "items": [TESTIMONIALS[0][:3], TESTIMONIALS[2][:3]]},
...
def location_page(slug, city, a1, a2, phone, phone_href, region):
    lat_lng = {"winston-salem": (36.0999, -80.2442), "greensboro": (36.0726, -79.7920), "charlotte": (35.2271, -80.8431), "raleigh": (35.7796, -78.6382)}[slug]
    return {"file": f"locations/{slug}.html", "title": f"Copiers, managed print and IT in {city}, NC | Kelly Office Solutions",
            "description": f"Kelly Office Solutions in {city}: copier sales, lease and repair, managed print, document management and IT for {region} businesses. {a1}, {a2}. {phone}.",
            "schema": [{"@context": "https://schema.org", "@type": "LocalBusiness", "@id": f"https://kellyofficesolutions.com/locations/{slug}#branch", "name": f"Kelly Office Solutions {city}",
                        ...
                        "areaServed": region, "openingHoursSpecification": {"@type": "OpeningHoursSpecification", "dayOfWeek": ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"], "opens": "08:00", "closes": "17:00"},
                        "sameAs": ["https://www.linkedin.com/company/kelly-office-solutions/"]}],
            "sections": [
                {"type": "hero", "layout": "split", "eyebrow": f"{region}", "heading": f"Copiers, managed print and IT in <em>{city}</em>, serviced from {city}.",
                 "subhead": f"The Kelly {city} branch serves {region} with sales, service dispatch and supplies. Call the branch, or 1-800-34-KELLY reaches all four.",
                 ...
                 "badge": {"value": "Same day", "label": "Response under a Kelly agreement"}},
                {"type": "cards", "alt": True, "eyebrow": f"In {city}", "heading": f"What the {city} branch does", "items": [
                    ...
                    ["Copier and printer repair", f"Same-day response under a Kelly agreement across {region}, with parts for the models we sell."],
                ...
                {"type": "locations", "heading": f"Visit or call the {city} branch", "intro": f"Hours to confirm with the branch. {a1}, {a2}.", "items": [[city, a1, a2, phone, phone_href]]},
                ...
                {"type": "faq", "heading": f"Questions we get in {city}", "items": [
                    [f"Do you serve businesses outside {city}?", f"Yes. The {city} branch covers {region}, and customers with offices elsewhere in North Carolina are served from the nearest of our four branches."],
                    ["How fast can you get a technician to us?", "Same day for devices under a Kelly agreement. Ask the branch for the terms of your agreement."],
...
def service_page(slug, title, navlabel, image, eyebrow, heading, subhead, benefits, bullets, faq):
    secs = [
        ...
        {"type": "cards", "alt": True, "eyebrow": "Benefits", "heading": f"What changes with Kelly {title.lower().split(':')[0]}", "items": benefits},
        {"type": "detail", "eyebrow": "What is included", "heading": "What you get", "body": subhead, "bullets": bullets, "image": image, "flip": True},
    ]
    if slug == "production-print":
        secs.insert(2, {"type": "video", "heading": "Production print, in ninety seconds", "intro": "Josh from Kelly walks through what an in-house production system does.", "video": "assets/production-print-josh.mp4", "poster": "assets/production-print-1200.jpg", "caption": "From kellyofficesolutions.com"})
    if slug == "managed-print":
        ...
        secs.insert(3, {"type": "tabs", "id": "assessment-steps", "alt": True, "eyebrow": "The assessment, step by step", "heading": "Four steps, and you keep the report either way",
            "items": [
                {"label": "Assess", "title": "Assess the fleet you have", "body": "A Kelly specialist evaluates your current imaging fleet for size, efficiency and cost, and talks with the people who use it about how the work actually flows.", "bullets": ["Every device counted, located and metered", "Cost per page by device, mono and color", "Interviews with the staff who print most"], "image": "assets/mps-1-1200.jpg", "image_alt": "A Kelly specialist reviewing a copier fleet with a customer"},
    ...
    secs += [
        {"type": "testimonials", "alt": True, "heading": "What customers say", "items": [TESTIMONIALS[1][:3], TESTIMONIALS[3][:3]]},
        {"type": "faq", "heading": "Questions we get about " + title.lower().split(":")[0], "items": faq},
        {"type": "leadform", "alt": True, "id": "assessment", "heading": "Start with the assessment", "body": "A specialist from your nearest branch walks your fleet and your workflows, and writes it up.", "submit": "Request my assessment", "note": "A person from the nearest branch replies, not an autoresponder."},
    ]
    return {"file": f"services/{slug}.html", "title": f"{title} | Kelly Office Solutions, North Carolina", "description": subhead[:158], "sections": secs}


def blog_post_page(p, others):
    related = [[o["category"], o["title"], brief(o["standfirst"], 110), f"blog/{o['slug']}.html", o["image"]] for o in others[:3]]
    faq_items = p["faq"]
    return {"file": f"blog/{p['slug']}.html", "title": f"{p['title']} | Kelly Office Solutions", "description": p["standfirst"][:158],
...
def build():
    brand = {
        ...
        "footer_columns": [
            {"title": "What we do", "links": [[s[2], f"services/{s[0]}.html"] for s in SERVICES]},
    ...
    nav = [["What we do", "what-we-do.html"], ["Industries", "industries.html"], ["Supplies & service", "service-support.html"], ["Cost calculator", "cost-calculator.html"], ["About", "about.html"], ["Locations", "locations.html"], ["Blog", "blog.html"]]
    ...
    pages.append({"file": "index.html", "title": "Kelly Office Solutions | Copiers, managed print, IT and office technology in North Carolina",
                  "description": "Family-owned since 1947 and headquartered in Winston-Salem. Copiers and managed print, document management, IT, mailing, water and coffee for North Carolina businesses, from four local offices, with same-day response under a Kelly agreement.",
                  "sections": [
        {"type": "hero", "layout": "split", "eyebrow": "Moving business forward since 1947",
         "heading": "Fully connected office systems, serviced by people who <em>show up the same day</em>.",
         "subhead": "Copiers and print, document management, IT, mailing, and the water and coffee that keep an office running. One North Carolina partner, four locations, one number to call.",
         ...
         "note": "Ricoh, Savin, Konica Minolta, Sharp and Brother dealer", "image": "assets/hero-1200.jpg", "image_alt": "A technician kneeling beside an open office copier, replacing a toner unit", "image_w": 1200, "image_h": 800,
         "badge": {"value": "94.4", "label": "Net Promoter Score, independently audited"}},
        {"type": "partners", "caption": "Technology partners", "items": PARTNERS},
        {"type": "stats", "alt": True, "items": [["1947", "Family-owned since"], ["94.4", "NPS, audited by CEO Juice (industry average: 70s)"], ["4,000", "Customers, most of them in North Carolina"], ["4", "Locations: Winston-Salem, Greensboro, Charlotte, Raleigh"]]},
        {"type": "checklist", "id": "is-this-you", "eyebrow": "Is this you?", "heading": "Six signs your office spends more on print than it knows",
         "intro": "Tick what sounds familiar. Nobody is watching.",
         ...
         "messages": ["Tick what sounds familiar.", "One is normal.", "Two is a pattern.", "Three or more is money leaving the building every month. The assessment finds how much."],
        ...
        {"type": "video", "alt": True, "eyebrow": "Who we are", "heading": "Thirty seconds on Kelly", "intro": "Family-owned since 1947, headquartered in Winston-Salem, with branches in Greensboro, Charlotte and Raleigh.", "vimeo": "271855836", "poster": "assets/vimeo-poster.jpg", "title": "Kelly Office Solutions", "caption": "Kelly's own film, from kellyofficesolutions.com"},
        {"type": "process", "eyebrow": "How we would stage an engagement", "heading": "Five stages, and every one of them hands you something",
         "stages": [["Assessment", "Produces: a fleet and cost report, yours to keep."], ["Plan", "Produces: a right-sized device plan with lease, rental or purchase priced side by side."], ["Install and connect", "Produces: every device on your network, every user trained, on a date you chose."], ["Monitor and supply", "Produces: toner that arrives before it runs out, and a monthly usage report."], ["Review", "Produces: a quarterly look at cost per page and uptime, then back to stage one if anything moved."]]},
        {"type": "testimonials", "alt": True, "eyebrow": "What customers say", "heading": "Four customers, in their own words", "items": [t[:3] for t in TESTIMONIALS]},
        ...
        {"type": "band", "eyebrow": "Supplies and service", "heading": "Already a customer? This is the fast lane.",
         ...
         "items": [["Request service", "Same-day response under a Kelly agreement", "service-support.html#request"], ["Meter reads", "Or let us read them automatically", "service-support.html#meters"], ["Copier supplies", "Toner and parts, shipped before you run out", "service-support.html#supplies"], ["Coffee and water supplies", "Beans, filters and cups on your schedule", "service-support.html#supplies"]]},
        {"type": "locations", "heading": "Four North Carolina locations", "intro": "Every one staffed with local technicians. Call the branch, or 1-800-34-KELLY reaches all of them.",
         "items": [[l[1], l[2], l[3], l[4], l[5]] for l in LOCATIONS]},
        {"type": "faq", "alt": True, "heading": "Questions we get on the first call", "items": [
            ["How fast do you respond to a service call?", "Same day, in all four territories, for devices under a Kelly service agreement. Technicians carry parts for the models we sell. Our NPS of 94.4 is audited by an independent third party, so that claim is checked by someone other than us."],
            ...
            ["Do you serve offices outside the Triad and Charlotte?", "Our four locations cover the Triad, Charlotte and the Triangle, and customers with field offices across North Carolina are served from the nearest branch. If you are further afield, ask your nearest branch."]]},
        {"type": "contact", "id": "contact", "heading": "Start with the assessment", "body": "A specialist walks your fleet and your workflows. Our recommendation: you keep the report whether or not you buy. About an hour of your time.",
    ...
    # ---------------- service & support
    pages.append({"file": "service-support.html", "title": "Supplies and service | Kelly Office Solutions", "description": "Request service, send meter reads and order copier, coffee and water supplies. Same-day response under a Kelly agreement across Winston-Salem, Greensboro, Charlotte and Raleigh.",
                  "sections": [
        {"type": "hero", "layout": "centered", "eyebrow": "Supplies and service", "heading": "Already a customer? <em>This is the fast lane.</em>", "subhead": "Everything an existing customer needs, one click deep. Same-day response under a Kelly agreement in all four territories, and a technician who carries parts for the models we sell.", "primary": {"label": "Request service", "href": "#request"}, "secondary": {"label": f"Call {PHONE}", "href": PHONE_HREF}},
        {"type": "band", "eyebrow": "Fast lane", "heading": "Four things, under a minute each", "subhead": "Or call. A person answers.", "items": [["Request service", "Same-day response under a Kelly agreement", "#request"], ["Meter reads", "Send a read, or let us read them automatically", "#meters"], ["Copier supplies", "Toner and parts, shipped before you run out", "#supplies"], ["Coffee and water supplies", "Beans, filters and cups on your schedule", "#supplies"]]},
        {"type": "detail", "id": "request", "eyebrow": "Service", "heading": "Request service", "body": "Tell us the device and what it is doing. Dispatch confirms a window for customers under a Kelly agreement, and the technician arrives with parts for the models we sell.", "bullets": ["Same-day response under a Kelly agreement, in all four territories", "Technicians for Ricoh, Konica Minolta, Sharp and Brother", "Loaner devices when a repair needs the shop", "Every call tracked in the customer portal"], "form": {"fields": ["Company", "Device serial or location", "What is it doing?"], "submit": "Request service"}},
        {"type": "detail", "id": "meters", "alt": True, "eyebrow": "Meters", "heading": "Meter reads", "body": "Send a read in thirty seconds, or ask about automatic meter collection so you never do it again.", "bullets": ["Web form, email or automatic collection", "Reads feed billing directly, so invoices match usage", "Monthly usage report on managed fleets"], "form": {"fields": ["Company", "Device serial", "Meter reading"], "submit": "Send meter read"}},
    ...
    pages.append({"file": "cost-calculator.html", "title": "Print cost calculator | Kelly Office Solutions", "description": "Estimate what your office spends on printing today: devices, mono and color pages, staff time. Typical North Carolina rates; the assessment replaces them with your meters.",
        ...
        {"type": "calculator", "id": "calc", "alt": True, "eyebrow": "Estimate", "heading": "Your print spend, estimated", "intro": "Devices, mono pages and color pages a month. That is all it needs.",
         "rates": {"mono_cpp": 0.018, "color_cpp": 0.09, "minutes_per_device_week": 25, "hourly": 28, "managed_saving": 0.22},
        ...
        {"type": "faq", "alt": True, "heading": "About the estimate", "items": [["Where do the rates come from?", "Typical per-page rates for toner and service in North Carolina, and a modest allowance for the staff time spent ordering supplies and chasing repairs. They are for orientation only."], ["Why does staff time count?", "Because it is real money that never appears on a print invoice. Someone orders the toner and waits on hold for the technician."], ["How do I get the real number?", "Request the assessment. We read every meter, collect every invoice and hand you the report."]]},
        {"type": "leadform", "id": "assessment", "heading": "Get the real number", "body": "A specialist from your nearest branch walks your fleet and your workflows, and writes it up. Our recommendation: you keep the report whether or not you buy.", "submit": "Request my assessment", "note": "A person from the nearest branch replies, not an autoresponder."},
    ]})
    pages.append({"file": "assessment.html", "title": "The Kelly assessment | What it covers and what you receive", "description": "One visit, one report: every device, every meter, every invoice, and a plan that prices lease, rental and purchase side by side. Our recommendation: you keep the report whether or not you buy.",
                  "sections": [
        ...
        {"type": "checklist", "alt": True, "id": "ready", "eyebrow": "Before we visit", "heading": "Four things that make the hour count", "intro": "None is required. Each one makes the report sharper.", "items": ["A list of devices, or a walk-through of where they are", "Last year's toner and service invoices", "The name of whoever orders supplies today", "Any device that has been down more than a day this year"], "messages": ["Tick what you can bring.", "One helps.", "Two is a good start.", "Three or more and the report will be exact."], "cta_label": "Request an assessment", "cta_href": "contact.html"},
        {"type": "faq", "heading": "Questions about the assessment", "items": [["What does it cost?", "Ask your branch. Our recommendation is that you keep the report whether or not you buy."], ["How long does it take?", "About an hour of your time on site, and a few days for the report."], ["Do you assess devices you did not sell?", "Yes. The report covers the whole fleet, and says which devices are worth keeping."]]},
    ...
    # ---------------- about, careers
    pages.append({"file": "about.html", "title": "About Kelly | Family-owned office technology since 1947, Winston-Salem", "description": "Kelly Office Solutions has served North Carolina since 1947: co-owners Tim Renegar and Peter Kelly, about 90 people, four offices, an audited NPS of 94.4, and a long record of community support in the Triad.",
                  "sections": [
        {"type": "hero", "layout": "centered", "eyebrow": "About Kelly", "heading": "Family-owned since 1947. <em>Still local, on purpose.</em>", "subhead": "Kelly started in 1947 selling office equipment and stayed independent while most of the industry consolidated. Today about 90 people across four North Carolina offices serve some 4,000 customers, and the phone is still answered by someone who works here.", "primary": {"label": "Meet the owners", "href": "#leadership"}, "image": "assets/kelly-team-1024.jpg", "image_alt": "A Kelly technician beside a Kelly service van", "image_w": 1024, "image_h": 576},
        {"type": "stats", "alt": True, "items": [["1947", "Founded in North Carolina"], ["90", "People, across four offices"], ["94.4", "Net Promoter Score, audited by CEO Juice"], ["4,000", "Customers, most of them in North Carolina"]]},
        {"type": "timeline", "eyebrow": "The story", "heading": "From one office to four, and from copiers to the whole office", "items": [["1947", "Kelly opens", "Selling and servicing office equipment in Winston-Salem."], ["1960", "BBB accredited", "Accredited since 1960 and rated A+ today."], ["2000s", "Managed print and IT", "The fleet goes under one agreement; managed IT and DocuWare follow."], ["Today", "Four offices, seven lines", "Winston-Salem, Greensboro, Charlotte and Raleigh. Copiers to coffee, one number."]]},
        {"type": "leadership", "id": "leadership", "heading": "The owners", "intro": "Tim and Peter are co-owners of Kelly Office Solutions, with over 45 years of experience in the industry between them.", "people": [["Tim Renegar", "Co-owner"], ["Peter Kelly", "Co-owner"]], "orgs_intro": "Kelly supports the organizations that serve its communities, and is a sponsor and member of the local chambers.", "orgs": COMMUNITY},
        ...
        {"type": "casestudy", "eyebrow": "What customers say", "heading": "Same-day repair, in tax season", "quote": TAX_SEASON[0], "attribution": f"{TAX_SEASON[1]}, {TAX_SEASON[2]}", "metrics": [["Since", "1947", "Independent and family-owned"], ["BBB", "A+", "Accredited since 1960"], ["Offices", "4", "Winston-Salem, Greensboro, Charlotte, Raleigh"], ["Service", "Same day", "Under a Kelly agreement, all four territories"]]},
    ...
    pages.append({"file": "careers.html", "title": "Careers | Kelly Office Solutions", "description": "Kelly Office Solutions is always looking for energetic, creative problem solvers with an outstanding work ethic and advanced customer service skills. Headquartered in Winston-Salem, with branches in Greensboro, Charlotte and Raleigh.",
                  "sections": [
        {"type": "hero", "layout": "centered", "eyebrow": "Careers", "heading": "Work for a company that <em>still answers the phone</em>.", "subhead": "Kelly is a leading provider of copiers and printers, managed IT services, document management, telecom, and coffee and pure water technology. We are always looking for energetic, creative problem solvers with an outstanding work ethic and advanced customer service skills.", "primary": {"label": "Ask about open roles", "href": "contact.html"}},
        {"type": "values", "alt": True, "eyebrow": "What we offer", "heading": "A family-friendly place to do serious work", "items": [["Competitive salary", "And a generous benefits package with a 401K plan."], ["Four offices", "Headquartered in Winston-Salem, with branches in Greensboro, Charlotte and Raleigh."], ["Equal opportunity", "We are an equal opportunity employer and appreciate a diverse workforce and environment. Candidates must be authorized to work in the United States."]]},
        {"type": "leadform", "id": "apply", "heading": "Tell us about yourself", "body": "Send a note and the role you are interested in. A person replies.", "submit": "Send", "note": "Or email info@kellyofficesolutions.com."},
    ]})
    # ---------------- locations index + pages
    pages.append({"file": "locations.html", "title": "Locations | Kelly Office Solutions in Winston-Salem, Greensboro, Charlotte and Raleigh", "description": "Four North Carolina offices with local technicians: Winston-Salem (headquarters), Greensboro, Charlotte and Raleigh. Copier, print, IT and coffee service across the Triad, Charlotte and the Triangle.",
                  "sections": [
        {"type": "hero", "layout": "centered", "eyebrow": "Locations", "heading": "Four offices. <em>Local technicians at every one.</em>", "subhead": "Headquartered in Winston-Salem, with branches in Greensboro, Charlotte and Raleigh. Call the branch nearest you, or 1-800-34-KELLY reaches all of them.", "primary": {"label": f"Call {PHONE}", "href": PHONE_HREF}},
    ...
    pages.append({"file": "blog.html", "title": "Blog | Kelly Office Solutions", "description": "Plain-spoken guides on managed print, copiers, document management, office IT and the break room, from the Kelly team in North Carolina.",
        ...
        {"type": "related", "heading": "The guides", "intro": "Start with what managed print costs, or how to read a lease.", "items": [[p["category"], p["title"], brief(p["standfirst"]), f"blog/{p['slug']}.html", p["image"]] for p in BLOG]},
        {"type": "leadform", "alt": True, "id": "guide", "heading": "Get the print cost guide", "body": "What a page really costs, the three numbers to ask any dealer for, and how to read a lease. Ten pages, no pitch.", "submit": "Send me the guide", "note": "One email with the guide. Nothing else unless you ask."},
    ]})
    ...
    pages.append({"file": "contact.html", "title": "Contact | Kelly Office Solutions", "description": "Request an assessment or talk to the nearest Kelly branch. Winston-Salem, Greensboro, Charlotte and Raleigh, or 1-800-34-KELLY.",
        ...
        {"type": "locations", "alt": True, "heading": "Or call the branch", "intro": "1-800-34-KELLY reaches all four.", "items": [[l[1], l[2], l[3], l[4], l[5]] for l in LOCATIONS]},
    ]})
    ...
    pitch = {
        ...
        "found": [
            ...
            "The only page earning strangers today is the Charlotte location page. Every direction now has four location pages with local business schema.",
        ...
        "pick_reasons": [
            ...
            ["Green and navy", "Clean gives the navy the chrome and the green the actions, so both brand colours do real work instead of competing."]],
        ...
        "plan": [
            ...
            ["Weeks 2 to 3", "Copy for every page, from your service leadership and from you, in your words. Photography scheduled at all four offices."],
        ...
        "confirm": [
            "The response commitment: what you promise today, and for which agreements. The pages say same-day under a Kelly agreement; the exact terms are yours to state.",
            "The BBB wording. We have written BBB-accredited since 1960, rated A+. Please confirm both halves.",
